...
# conductor = Conductor_That_AnimatesOnScreen_OLD(simulation_module=simulation)
conductor = Conductor_That_AnimatesOnScreen(simulation_module=simulation, target_fps=60.0)
