...
def draw_state(system_state: SystemState, velocity_arrow_scale=10):
    ax = plt.subplots()[1]
    ax.clear()
    ...
    ax.quiver(system_state.balls_location[:, 0], system_state.balls_location[:, 1], system_state.balls_velocity[:, 0], system_state.balls_velocity[:, 1], color=(0.8, 0.2, 0.2, 0.9), edgecolor="k",
