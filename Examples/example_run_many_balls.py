...
# conductor = ConductorWithProgressBar(simulation_module=simulation, simulation_time_timeout=10)
conductor = ConductorThatAnimatesToFile(simulation_module=simulation, target_fps=100, length_seconds=200, file_name=__file__ + ".mp4")
